...
- [X] `GET /garages` — list all garages (including featured ones)
- [X] `GET /garages/:garageId` — fetch public profile & services
- [X] `GET /promos` — fetch active deals, offers, and promotions
- [X] Database migration/seed: populate garages, services, and offers/promos tables.
