                 ...
                 <tbody className="divide-y divide-slate-100">
                   {loading ? (
                     ...
                     <tr key={h.id} className="hover:bg-slate-50 transition-colors">
                       ...
                       <td className="p-4 align-top text-xs font-bold text-[#17307a]">₹{h.quoteAmount}</td>
                       ...
                       <td className="p-4 align-top text-right">
                         ...
                         <div className="flex justify-end gap-2"><button className="text-blue-500 hover:text-blue-700 p-1"><Eye className="w-4 h-4"/></button></div>
                       </td>
                     </tr>
                   ))}
                 </tbody>
...
console.log('Replaced Garage Service History content successfully.');
