    ...
    <DashboardShell header={<TopNavbar />}>
      <div className="p-4 space-y-6">
        ...
        {filteredAll.length > 0 && (
          <div>
            <h3 className="font-bold text-slate-900 mb-4">More Offers</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
               {filteredAll.map((offer) => (
                 <Card key={offer.id} className="p-4 flex gap-4 border-slate-100 shadow-sm hover:border-blue-200 transition-colors cursor-pointer group rounded-[20px]" onClick={() => setSelectedOffer(offer)}>
                    <div className={cn("w-24 h-24 rounded-xl flex items-center justify-center shrink-0 border border-slate-100 relative overflow-hidden", offer.bg)}>
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      <p className="text-xs text-slate-500 line-clamp-2 mb-2">{offer.desc}</p>
          ...
          <div className="space-y-4">
             ...
             <div>
               <div className="flex justify-between items-center mb-2">
                 ...
                 <span className="text-xs text-slate-500 font-medium">Valid till {selectedOffer.validTill}</span>
               </div>
               ...
               <p className="text-sm text-slate-600 my-4">{selectedOffer.desc}</p>
               
               <div className="bg-slate-50 rounded-lg p-3 flex items-center gap-3 border border-slate-100 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900">{selectedOffer.garage}</p>
                  </div>
