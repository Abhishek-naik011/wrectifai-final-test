      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/login" className="text-sm font-medium text-[#1a56db] transition-colors">
              Log In
            </Link>
            <Link href="/signup">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100">
          ...
          <div className="w-full max-w-md bg-white/90 backdrop-blur-xl rounded-3xl border border-white/80 p-8 sm:p-10 shadow-[0_20px_60px_rgba(23,48,122,0.08)] relative z-10 transition-all">
            <div className="text-center mb-6">
              <div className="inline-flex items-center justify-center h-14 w-14 rounded-full bg-orange-50 text-orange-600 mb-4 ring-8 ring-white">
                <Lock className="h-6 w-6" />
              </div>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-[#17307a] tracking-tight">Security Update</h1>
            ...
            {errorMsg && (
              <div className="mb-6 p-4 bg-red-50 border border-red-100 rounded-xl text-sm font-semibold text-red-600 flex items-center gap-2">
            ...
            <form onSubmit={handlePasswordReset} className="space-y-5">
              <div>
                <label className="block text-xs font-bold text-[#17307a] uppercase tracking-wide mb-2">New Password</label>
                <input
                  type="password"
                  required
                  value={newPassword}
                  ...
                  className="h-12 w-full rounded-xl border border-slate-200 bg-white px-4 text-sm text-[#17307a] placeholder-slate-400 outline-none transition-all focus:border-[#1a56db] focus:ring-2 focus:ring-[#1a56db]/20"
                />
              </div>
              <div>
                <label className="block text-xs font-bold text-[#17307a] uppercase tracking-wide mb-2">Confirm Password</label>
                <input
                  type="password"
                  required
              ...
              <button
                ...
                className="w-full h-12 rounded-xl bg-[#1a56db] text-white text-[15px] font-bold hover:bg-[#1546b5] transition-all flex items-center justify-center mt-2 disabled:opacity-50 shadow-lg shadow-blue-500/20"
              >
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100">
        ...
        <div className="w-full max-w-md bg-white/90 backdrop-blur-xl rounded-3xl border border-white/80 p-8 sm:p-10 shadow-[0_20px_60px_rgba(23,48,122,0.08)] relative z-10 transition-all">
          <div className="text-center mb-8">
            <span className="text-blue-600 font-bold tracking-wider text-xs mb-4 block">WELCOME BACK</span>
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-[#17307a] tracking-tight">Log in to WrectifAI</h1>
            <p className="text-[13px] text-slate-500 mt-2 font-medium">Manage your vehicles, AI Diagnose, Quotes and Bookings from one place.</p>
          </div>
          ...
          {!isEmailMode ? (
            ...
            !isOtpSent ? (
              <form onSubmit={handleSendOtp} className="space-y-5">
                <div>
                  <label className="block text-xs font-bold text-[#17307a] uppercase tracking-wide mb-2">Phone Number or Email</label>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-5">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="block text-xs font-bold text-[#17307a] uppercase tracking-wide">Email Address</label>
                  <button
                    type="button"
              ...
              <div>
                <label className="block text-xs font-bold text-[#17307a] uppercase tracking-wide mb-2">Password</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
